...
void MCU_init(void)
{
  ...
  PORTD_PCR9 = (uint32_t)((PORTD_PCR9 & (uint32_t)~0x01000500UL) | (uint32_t)0x0200UL);
  /* PORTD_PCR8: ISF=0,MUX=2 */
  PORTD_PCR8 = (uint32_t)((PORTD_PCR8 & (uint32_t)~0x01000500UL) | (uint32_t)0x0200UL);
  /* ADC0_CFG2: MUXSEL=1 */
  ADC0_CFG2 |= (uint32_t)0x10UL;                       
  ...
  PORTA_PCR17 &= (uint32_t)~0x01000700UL;                      
  /* ### Init_FTM init code */
  /* SIM_SCGC6: FTM0=1 */
  ...
  /* FTM0_C0SC: CHF=0,CHIE=0,MSB=0,MSA=0,ELSB=0,ELSA=0,DMA=0 */
  ...
  FTM0_COMBINE &= (uint32_t)~0x72777272UL;                      
  ...
  FTM0_C2SC &= (uint32_t)~0xFFFFFFBEUL;                      
  /* FTM0_C3SC: CHF=0,MSB=0,MSA=0,ELSB=0,ELSA=0 */
  FTM0_C3SC &= (uint32_t)~0xFFFFFFBEUL;                      
  /* FTM0_C4SC: CHF=0,CHIE=0,MSB=1,ELSB=0,ELSA=1,DMA=0 */
  FTM0_C4SC = (uint32_t)((FTM0_C4SC & (uint32_t)~0xFFFFFFCBUL) | (uint32_t)0x24UL);
  ...
  /* FTM0_C4V: VAL=0x04E1 */
  FTM0_C4V = (uint32_t)0x04E1UL;                  
  /* FTM0_OUTINIT:  */
  FTM0_OUTINIT &= (uint32_t)~0xFFFFFF00UL;                      
  ...
  /* FTM0_MOD: MOD=0x09C3 */
  FTM0_MOD = (uint32_t)((FTM0_MOD & (uint32_t)~0xF63CUL) | (uint32_t)0x09C3UL);
  /* FTM0_CNTIN: INIT=0 */
  ...
  FTM0_MODE = (uint32_t)((FTM0_MODE & (uint32_t)~0xFFFFFFE9UL) | (uint32_t)0x02UL);
  ...
  FTM0_PWMLOAD = (uint32_t)((FTM0_PWMLOAD & (uint32_t)~0x02EFUL) | (uint32_t)0x10UL);
  /* ### Init_FTM init code */
  /* SIM_SCGC6: FTM1=1 */
  ...
  /* FTM1_C0SC: CHF=0,CHIE=0,MSB=0,MSA=0,ELSB=0,ELSA=0,DMA=0 */
  FTM1_C0SC = (uint32_t)0x00UL;                  
  /* FTM1_C1SC: CHF=0,CHIE=0,MSB=0,MSA=0,ELSB=0,ELSA=0,DMA=0 */
  FTM1_C1SC = (uint32_t)0x00UL;                  
  /* FTM1_SC: TOF=0,CPWMS=0 */
  FTM1_SC &= (uint32_t)~0xA0UL;                      
  /* FTM1_MODE: WPDIS=1 */
  ...
  FTM1_C0SC &= (uint32_t)~0xFFFFFFBEUL;                      
  /* FTM1_C1SC: CHF=0,CHIE=0,MSB=1,ELSB=1,ELSA=0,DMA=0 */
  FTM1_C1SC = (uint32_t)((FTM1_C1SC & (uint32_t)~0xFFFFFFC7UL) | (uint32_t)0x28UL);
  /* FTM1_C1V: VAL=0xE470 */
  FTM1_C1V = (uint32_t)0xE470UL;                  
  /* FTM1_FILTER: CH1FVAL=0 */
  FTM1_FILTER &= (uint32_t)~0xF0UL;                      
  /* FTM1_OUTINIT:  */
  FTM1_OUTINIT &= (uint32_t)~0xFFFFFF00UL;                      
  ...
  /* FTM1_MOD: MOD=0xF423 */
  FTM1_MOD = (uint32_t)((FTM1_MOD & (uint32_t)~0x0BDCUL) | (uint32_t)0xF423UL);
  /* FTM1_CNTIN: INIT=0 */
  FTM1_CNTIN &= (uint32_t)~0xFFFFUL;                      
  /* FTM1_DEADTIME: DTPS=0,DTVAL=0 */
  FTM1_DEADTIME &= (uint32_t)~0xFFUL;                      
  /* FTM1_CNT: COUNT=0 */
  FTM1_CNT &= (uint32_t)~0xFFFFUL;                      
  /* FTM1_MODE: FAULTIE=0,FAULTM=0,PWMSYNC=0,INIT=1,FTMEN=0 */
  FTM1_MODE = (uint32_t)((FTM1_MODE & (uint32_t)~0xFFFFFFE9UL) | (uint32_t)0x02UL);
  ...
  FTM1_SC = (uint32_t)((FTM1_SC & (uint32_t)~0xF3UL) | (uint32_t)0x0CUL);
  ...
  PIT_LDVAL0 = (uint32_t)0x0007A120UL;                  
  /* PIT_LDVAL1: TSV=0x0003D090 */
  PIT_LDVAL1 = (uint32_t)0x0003D090UL;                  
  /* PIT_LDVAL2: TSV=0xC350 */
  PIT_LDVAL2 = (uint32_t)0xC350UL;                  
  /* PIT_LDVAL3: TSV=0 */
  PIT_LDVAL3 = (uint32_t)0x00UL;                  
  /* PIT_TCTRL0: TIE=1,TEN=0 */
  PIT_TCTRL0 = (uint32_t)0x02UL;                  
  /* PIT_TCTRL1: TIE=1,TEN=0 */
  PIT_TCTRL1 = (uint32_t)0x02UL;                  
  /* PIT_TCTRL2: TIE=1,TEN=0 */
  PIT_TCTRL2 = (uint32_t)0x02UL;                  
  /* PIT_TCTRL3: TIE=0,TEN=0 */
  PIT_TCTRL3 = (uint32_t)0x00UL;                  
  /* PIT_TCTRL0: TEN=1 */
  PIT_TCTRL0 |= (uint32_t)0x01UL;                       
  /* PIT_TCTRL1: TEN=1 */
  PIT_TCTRL1 |= (uint32_t)0x01UL;                       
  /* PIT_TCTRL2: TEN=1 */
  PIT_TCTRL2 |= (uint32_t)0x01UL;                       
  /* ### Init_GPIO init code */
  /* GPIOA_PDDR: PDD&=~0x3C00,PDD|=0x1401C000 */
  GPIOA_PDDR = (uint32_t)((GPIOA_PDDR & (uint32_t)~0x3C00UL) | (uint32_t)0x1401C000UL);
  /* ### Init_GPIO init code */
  /* GPIOB_PSOR: PTSO&=~0x0200 */
  GPIOB_PSOR &= (uint32_t)~0x0200UL;                      
  /* GPIOB_PCOR: PTCO|=0x0200 */
  GPIOB_PCOR |= (uint32_t)0x0200UL;                       
  /* GPIOB_PDDR: PDD&=~0xFF,PDD|=0x00500200 */
  GPIOB_PDDR = (uint32_t)((GPIOB_PDDR & (uint32_t)~0xFFUL) | (uint32_t)0x00500200UL);
  /* ### Init_GPIO init code */
  /* GPIOC_PSOR: PTSO|=0x1400 */
  GPIOC_PSOR |= (uint32_t)0x1400UL;                       
  /* GPIOC_PCOR: PTCO&=~0x1400 */
  GPIOC_PCOR &= (uint32_t)~0x1400UL;                      
  /* GPIOC_PDDR: PDD&=~0x00040000,PDD|=0x000AB50D */
  GPIOC_PDDR = (uint32_t)((GPIOC_PDDR & (uint32_t)~0x00040000UL) | (uint32_t)0x000AB50DUL);
  /* ### Init_GPIO init code */
  /* GPIOD_PSOR: PTSO|=0x5440 */
  GPIOD_PSOR |= (uint32_t)0x5440UL;                       
  /* GPIOD_PCOR: PTCO&=~0x5440 */
  GPIOD_PCOR &= (uint32_t)~0x5440UL;                      
  /* GPIOD_PDDR: PDD|=0x5440 */
  GPIOD_PDDR |= (uint32_t)0x5440UL;                       
  /* ### Init_GPIO init code */
  /* GPIOE_PSOR: PTSO|=0x10000000 */
  GPIOE_PSOR |= (uint32_t)0x10000000UL;                       
  /* GPIOE_PCOR: PTCO&=~0x10000000 */
  GPIOE_PCOR &= (uint32_t)~0x10000000UL;                      
  /* GPIOE_PDDR: PDD|=0x10000000 */
  GPIOE_PDDR |= (uint32_t)0x10000000UL;                       
  /* ### Init_UART init code */
  /* SIM_SCGC4: UART2=1 */
  SIM_SCGC4 |= (uint32_t)0x1000UL;                       
  /* UART2_C2: TE=0,RE=0 */
  UART2_C2 &= (uint8_t)~(uint8_t)0x0CU;                           
  /* UART2_BDL: SBR=0x1B */
  UART2_BDL = (uint8_t)0x1BU;                             
  ...
  UART2_CFIFO = (uint8_t)0xC0U;                             
  /* UART2_PFIFO: TXFE=1,RXFE=0 */
  UART2_PFIFO = (uint8_t)((UART2_PFIFO & (uint8_t)~(uint8_t)0x08U) | (uint8_t)0x80U);
  ...
  UART2_C2 = (uint8_t)0x2CU;                             
  /* ### Init_SPI init code */
  /* SIM_SCGC6: SPI1=1 */
  SIM_SCGC6 |= (uint32_t)0x2000UL;                       
  ...
  SPI1_MCR = (uint32_t)0x80010C01UL;                  
  /* SPI1_TCR: SPI_TCNT=0 */
  ...
  SPI1_CTAR0 = (uint32_t)0x38AA7678UL;                  
  ...
  SPI1_RSER = (uint32_t)0x00UL;                  
  /* ### Init_I2C init code */
  /* SIM_SCGC4: I2C0=1 */
  SIM_SCGC4 |= (uint32_t)0x40UL;                       
  /* I2C0_FLT: FLT=0 */
  I2C0_FLT = (uint8_t)0x00U;                             
  /* I2C0_A1: AD=0x4C */
  I2C0_A1 = (uint8_t)0x98U;                             
  /* I2C0_C2: GCAEN=0,ADEXT=0,HDRS=0,SBRC=0,RMEN=0,AD=0 */
  I2C0_C2 = (uint8_t)0x00U;                             
  /* I2C0_RA: RAD=0 */
  I2C0_RA = (uint8_t)0x00U;                             
  /* I2C0_F: MULT=2,ICR=0 */
  I2C0_F = (uint8_t)0x80U;                             
  /* I2C0_A2: SAD=0x61 */
  I2C0_A2 = (uint8_t)0xC2U;                             
  /* I2C0_SMB: FACK=0,ALERTEN=0,SIICAEN=0,TCKSEL=0,SLTF=1,SHTF1=0,SHTF2=1,SHTF2IE=0 */
  I2C0_SMB = (uint8_t)0x0AU;                             
  /* I2C0_SLTH: SSLT=0 */
  I2C0_SLTH = (uint8_t)0x00U;                             
  /* I2C0_SLTL: SSLT=0 */
  I2C0_SLTL = (uint8_t)0x00U;                             
  /* I2C0_S: TCF=0,IAAS=0,BUSY=0,ARBL=1,RAM=0,SRW=0,IICIF=1,RXAK=0 */
  I2C0_S = (uint8_t)0x12U;                             
  /* I2C0_C1: IICEN=1,IICIE=0,MST=0,TX=0,TXAK=0,RSTA=0,WUEN=0,DMAEN=0 */
  I2C0_C1 = (uint8_t)0x80U;                             
  /* ### Init_ADC init code */
  /* SIM_SCGC6: ADC0=1 */
  SIM_SCGC6 |= (uint32_t)0x08000000UL;                       
  /* ADC0_CFG1: ADLPC=0,ADIV=3,ADLSMP=1,MODE=0,ADICLK=1 */
  ADC0_CFG1 = (uint32_t)0x71UL;                  
  ...
  /* ADC0_SC3: CAL=0,CALF=0,ADCO=1,AVGE=1,AVGS=3 */
  ADC0_SC3 = (uint32_t)0x0FUL;                  
  /* ADC0_SC1A: COCO=0,AIEN=0,DIFF=0,ADCH=5 */
  ADC0_SC1A = (uint32_t)0x05UL;                  
  /* ADC0_SC1B: COCO=0,AIEN=0,DIFF=0,ADCH=0x1F */
  ADC0_SC1B = (uint32_t)0x1FUL;                  
  /* ### Init_ADC init code */
  /* SIM_SCGC3: ADC1=1 */
  SIM_SCGC3 |= (uint32_t)0x08000000UL;                       
  /* ADC1_CFG1: ADLPC=0,ADIV=3,ADLSMP=1,MODE=0,ADICLK=1 */
  ADC1_CFG1 = (uint32_t)0x71UL;                  
  /* ADC1_CFG2: ADACKEN=0,ADHSC=0,ADLSTS=0 */
  ADC1_CFG2 &= (uint32_t)~0xFFFFFFEFUL;                      
  /* ADC1_CV1: CV=0 */
  ADC1_CV1 = (uint32_t)0x00UL;                  
  /* ADC1_CV2: CV=0 */
  ADC1_CV2 = (uint32_t)0x00UL;                  
  /* ADC1_SC2: ADACT=0,ADTRG=0,ACFE=0,ACFGT=0,ACREN=0,DMAEN=0,REFSEL=0 */
  ADC1_SC2 = (uint32_t)0x00UL;                  
  /* ADC1_SC3: CAL=0,CALF=0,ADCO=1,AVGE=1,AVGS=3 */
  ADC1_SC3 = (uint32_t)0x0FUL;                  
  /* ADC1_SC1A: COCO=0,AIEN=0,DIFF=0,ADCH=0x11 */
  ADC1_SC1A = (uint32_t)0x11UL;                  
...
static __declspec(vectortable) tVectorTable __vect_table = { /* Interrupt vector table */
   __SP_INIT,                                              /* 0 (0x00000000) (prior: -) */
  {
   ...
   (tIsrFunc)&isrINT_I2C0,                                 /* 40 (0x000000A0) (prior: 0) */
   ...
   (tIsrFunc)&isrINT_ADC0,                                 /* 73 (0x00000124) (prior: 0) */
   (tIsrFunc)&isrINT_ADC1,                                 /* 74 (0x00000128) (prior: 0) */
